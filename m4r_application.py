...
market_excess_returns1 = pd.read_csv("market_excess_returns1.csv", header=None)


market_excess_returns1 = market_excess_returns1.apply(pd.to_numeric, errors='coerce')


market_excess_returns1 = market_excess_returns1.fillna(method='ffill').fillna(method='bfill')

market_excess_returns1_array = market_excess_returns1.values
...
market_excess_returns = market_excess_returns1_array
...
market_excess_returns1 = market_excess_returns1_array
